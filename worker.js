    ...
    try {
      ...
      if (validateEmail(email)) {
        ...
        try {
          ...
          throw new Error('Erreur de stockage de l\'abonnement');
        }
        
        // Send to Google Forms
        try {
          const params = new URLSearchParams();
          params.append('entry.1899983470', email);
          params.append('entry.1889021612', daily ? 'Hebdomadaire' : '');
          params.append('entry.1185604264', weekly ? 'Quotidien' : '');
          ...
          if (!formResponse.ok) {
            console.error('Google Forms error:', formResponse.statusText);
          }
        } catch (googleError) {
          console.error('Google Forms error:', googleError);
          // Continue execution even if Google Forms fails
        }
        ...
        try {
          ...
          throw new Error('Erreur d\'envoi de l\'email de confirmation');
        }
